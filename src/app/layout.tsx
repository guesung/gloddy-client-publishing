...
function Layout({ children }: StrictPropsWithChildren) {
  return (
    <html lang="ko">
      <body className="flex h-full min-h-[100dvh] w-screen touch-none justify-center overflow-y-scroll bg-slate-50">
        <div className="relative min-h-[100dvh] w-full max-w-450 overflow-scroll bg-white text-sign-primary">
          {children}
        </div>
      </body>
    </html>
